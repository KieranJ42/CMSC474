...
//	private static String[] outputFileList = {};
	...
	private static final String inFolder = "Part1-Skeleton\\tests"; // folder with input files (from project root)
	private static final String outFolder = "Part1-Skeleton\\\\tests"; // folder with output files (from project root)
