...
public class TestData {
  ...
  public static BusTerminal busTerminal1() {
    BusTerminal busTerminal= new BusTerminal(2);
  ...
  // Returns a busTerminal that has several buses, with different numbers of
  // passengers.  The buses are all only going to one city, but they are
  // going to different cities.
  public static BusTerminal busTerminal5() {
    BusTerminal busTerminal= new BusTerminal(10);
